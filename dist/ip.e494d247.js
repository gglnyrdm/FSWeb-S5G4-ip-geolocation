...
var geoapiPromise = _axios.default.get("https://apis.ergineer.com/ipgeoapi/178.233.21.68");
geoapiPromise.then(function (respo) {
...
*/
var newComponent = function newComponent(nesne) {
  ...
  h3.textContent = "".concat(sorgu);
  infoDiv.append(h3);
  var pUlke = document.createElement("p");
  pUlke.setAttribute("class", "ulke");
  pUlke.textContent = "".concat(ülke, " (").concat(ülkeKodu, ")");
  infoDiv.append(pUlke);
  var enBoyP = document.createElement("p");
  enBoyP.textContent = "Enlem : ".concat(enlem, " Boylam : ").concat(boylam);
  infoDiv.append(enBoyP);
  var sehirP = document.createElement("p");
  sehirP.textContent = "\u015Eehir : ".concat(şehir, " ");
  infoDiv.append(sehirP);
  var saatP = document.createElement("p");
  saatP.textContent = "Saat dilimi : ".concat(saatdilimi);
  infoDiv.append(saatP);
  var paraP = document.createElement("p");
  paraP.textContent = "Para birimi : ".concat(parabirimi);
  infoDiv.append(paraP);
  var ispP = document.createElement("p");
  ispP.textContent = "ISP : ".concat(isp);
  infoDiv.append(ispP);
  return cardDiv;
};
var kart = document.getElementsByClassName("cards")[0];
/*
	ADIM 4: API'den alınan verileri kullanarak ADIM 3'te verilen yapıda bir kart oluşturun ve 
	bu kartı DOM olarak .cards elementinin içine ekleyin. 
*/
var geoapiData = respo.data;
geoapiData.forEach(function (nesne) {
